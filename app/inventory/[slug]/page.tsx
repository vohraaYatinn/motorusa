...
import { ArrowLeft, Calendar, Gauge, Fuel, Cog, Phone, Mail, Check } from "lucide-react"
              ...
              <Card className="sticky top-24 border-border p-6 shadow-lg">
                ...
                <div className="mb-6 space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-card-foreground">{vehicleType}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    ...
                    <span className="flex items-center gap-1 font-medium text-card-foreground">
                      {repaint && <Check className="h-4 w-4 text-green-500" aria-hidden="true" />}
                      <span>{repaint ? "Yes" : "No"}</span>
                    </span>
                  </div>
                  <div className="flex justify-between">
